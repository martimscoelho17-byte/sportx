    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 flex flex-col items-center justify-center min-h-[calc(100vh-64px-80px)] relative overflow-hidden px-4 bg-white dark:bg-black">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-[#001a4d]/35 dark:bg-[#001a4d]/35 blur-3xl" />
          <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-[#660000]/25 dark:bg-[#660000]/25 blur-3xl" />
        </div>
